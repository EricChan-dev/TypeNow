...
export async function GET(request: NextRequest) {
  ...
  const rows = await db
    .select()
    .from(userNotes)
    .where(eq(userNotes.userId, session.userId))
...
export async function PUT(request: NextRequest) {
  ...
  await db
    .update(userNotes)
    .set(updates)
    .where(and(eq(userNotes.id, body.id), eq(userNotes.userId, session.userId)))
...
export async function DELETE(request: NextRequest) {
  ...
  await db
    .delete(userNotes)
    .where(and(eq(userNotes.id, id), eq(userNotes.userId, session.userId)))
