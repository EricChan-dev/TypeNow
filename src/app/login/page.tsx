        ...
        <aside className="hidden md:flex w-[45%] bg-[#1E40AF] relative flex-col items-center justify-center overflow-hidden px-12">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-3 mb-14">
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-white/15 p-1.5">
                <Image src="/logo.png" alt="TypeNow logo" width={40} height={40} className="w-full h-full object-contain" />
              </div>
