  ...
  return (
    <header className="h-[64px] shrink-0 border-b border-border bg-card flex items-center justify-between px-6">
      ...
      <Link href="/home" className="flex items-center gap-2.5 shrink-0">
        <Image src="/logo_w.svg" alt="TypeNow" width={30} height={30} className="hidden [.dark_&]:block" />
        <Image src="/logo.svg" alt="TypeNow" width={30} height={30} className="block [.dark_&]:hidden" />
